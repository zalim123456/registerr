...
client.on("guildMemberAdd", async member => {
  let yetkili = "794532354869166080"//kayıt yetkili id
   client.channels.get("790119598543994900").send(new Discord.RichEmbed()
                                   .setTitle(`Aramıza Hoşgeldin`)                                                
                                   .setDescription(`
${member.user.username} Aramıza Hoşgeldin Seni Aramızda Görmek Güzel!
Sunucumuzda kurallar kanalını okumayı unutma
<@&${yetkili}> Rolündekiler Seninle İlgilenecektir.  `)                                                
                                   .setImage("https://cdn.discordapp.com/attachments/789929957412831244/793029902101381180/kateria_yeni_gelen.gif")).then(client.channels.get("790119598543994900").send(`<@&${yetkili}>`))
});   