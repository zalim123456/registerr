...
module.exports.run = async (bot, message, args) => {
  ...
  const embed = new Discord.RichEmbed()
    .setColor("PURPLE")
    .setDescription(`<a:emoji_42:761161924728848404> <@${tomute.id}> ${ms(ms(mutetime))} boyunca susturuldu!`)
    .setFooter(bot.user.username, bot.user.avatarURL);
  ...
  setTimeout(function() {
    ...
    const embed = new Discord.RichEmbed()
      .setColor("PURPLE")
      .setDescription(`<a:emoji_9:761162287016312862> <@${tomute.id}> 'un susturulma süresi doldu!`)
      .setFooter(bot.user.username, bot.user.avatarURL);
